...
router.register(r'program_snapshots', views.ProgramSnapshotViewSet, base_name='programsnapshot')
router.register(r'actions', views.ActionsViewSet, base_name='action')
