...
export default {
  ...
  'mission.repeat-n-times': 'Opakuj N-krát',
  'mission.repeat-while': 'Opakuj dokud',
  'mission.loops-challenge': 'Cyklická výzva',
  'mission.color-decisions': 'Barevné rozhodování',
  'mission.position-decisions': 'Poziční rozhodování',
  'mission.if-else': 'Úplné rozhodování',
  'mission.final-challenge': 'Závěrečná výzva',

  'chunk.commands': 'Základní příkazy',
  'chunk.commands-2': 'Pokročilé příkazy',
  'chunk.repeat': 'Cyklus s daným počtem opakování',
  'chunk.while': 'Cyklus s podmínkou',
  'chunk.loops': 'Opakování cyklů',
  'chunk.if': 'Podmíněný příkaz',
  'chunk.comparing': 'Porovnávání',
  'chunk.if-else': 'Pokud-jinak',
  'chunk.loops-if': 'Cykly a podmíněné příkazy',
