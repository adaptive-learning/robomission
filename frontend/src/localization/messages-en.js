...
export default {
  ...
  'mission.spaceship-control': 'Spaceship Control',
  'mission.shooting-and-wormholes': 'Shooting and Wormholes',
  'mission.repeat-n-times': 'Repeat N-times',
  'mission.repeat-while': 'While-Do',
  'mission.loops-challenge': 'Looping Challenge',
  'mission.color-decisions': 'Color Decisions',
  'mission.position-decisions': 'Position Decisions',
  'mission.if-else': 'Complete Decisions',
  'mission.final-challenge': 'Final Challenge',

  'chunk.commands': 'Basic Commands',
  'chunk.commands-2': 'Advanced Commands',
  'chunk.repeat': 'Loop with Number of Iterations',
  'chunk.while': 'Loop with Condition',
  'chunk.loops': 'Practicing Loops',
  'chunk.if': 'Conditional Statement',
  'chunk.comparing': 'Comparing',
  'chunk.if-else': 'If-Else',
  'chunk.loops-if': 'Loops and Conditional Statements',
